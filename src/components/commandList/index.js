  ...
  return (
    <div className="row commandList">
      ...
      <div className="pull-left col-md-9" id="faq">
        ...
        <h2 id="startrace">.startrace <em>game</em> <span>main channel</span></h2>
        ...
        <h2 id="done">.done <span>race channel</span></h2>
        ...
        <h2 id="comment">.comment <em>comment</em> <span>race channel</span></h2>
        <p>You may leave a comment on a race that you finished participating in. Limit is 140 characters.</p>

        <h2 id="rematch">.rematch <span>race channel</span></h2>
        ...
        <h2 id="races">.races <span>main channel</span></h2>
        <p>Checks which races are going on.</p>

        <h2 id="setstream">.setstream <em>url</em> <span>all channels</span></h2>
        <p>Use this to set your stream on SRL.</p>
        <p>Example: <code>.setstream http://twitch.tv/blechzorz</code></p>

        <h2 id="streamoption">.streamoption <em>option</em> <span>all channels</span></h2>
        ...
        <h2 id="stream">.stream <em>name</em> <span>all channels</span></h2>
        <p>Gives the stream url of the requested name.</p>

        <h2 id="settwitter">.settwitter <em>twitter</em> <span>all channels</span></h2>
        <p>Use this to set your Twitter account.</p>

        <h2 id="twit">.twitter <em>name</em> <span>all channels</span></h2>
        <p>Gives the Twitter account of the requested name.</p>

        <h2 id="setyoutube">.setyoutube <em>account</em> <span>all channels</span></h2>
        <p>Use this to set your YouTube account.</p>

        <h2 id="youtube">.youtube <em>name</em> <span>all channels</span></h2>
        <p>Gives the YouTube account of the requested name.</p>

        <h2 id="filename">.filename <span>race channel</span></h2>
        ...
        <h2 id="dq">.dq <em>name</em> <em>reason</em> <span>race channel</span></h2>
        ...
        <h2 id="remove">.remove <em>name</em> <span>race channel</span></h2>
        ...
        <h2 id="creategame">.creategame <em>game</em> <em>Full Game Name</em> <span>all channels</span></h2>
        ...
        <h2 id="purge">.purge <em>name</em> <span>all channels</span></h2>
