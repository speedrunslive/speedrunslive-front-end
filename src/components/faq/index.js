...
Most of all, we're all in this to have a good time. While races have potential for really great competition, it's all about fun.</p><br />
            ...
            <p>
                We also offer an embedded IRC client on our site <a href="/channel/">here</a>. However, the mibbit client lacks many features that other IRC clients have, so we heavily suggest using a full IRC client such as those mentioned above.
            </p>
            <br />
            <h3> 2. Join our IRC channel</h3>

            <p>In the server connection window of your IRC client, you may connect to either of the following servers, based on your location:</p>
            <p>
            ...
            <p>We'd also suggest using the <code>/list</code> command, which lists the many channels which make up the SRL IRC. These range from game-specific channels to general subgroups of our large community.</p>
            <br />
            <h3 id="getregged">4. Register your nick</h3>

            <p>&mdash;Step 1: Sign on to the nick you want to use for all future races, and type <code>/nickserv register <em>password e-mail</em></code>.<br />
                Note: It is important that you enter your actual e-mail address, in case you need to retrieve your password in the future.
</p>

            <p>&mdash;Step 2: When logging onto the IRC, you can log in by signing on to your nick, and typing <code>/nickserv identify <em>password</em></code>.</p>

            <p>&mdash;Step 3 (optional): Set up automatic login within your IRC client. You may do this in mIRC by going to Options, then the Connect menu, then the Options menu. Click Perform, and type <code>/nickserv identify <em>password</em></code>.<br /> mIRC will automatically enter your password when you join the SRL IRC in the future.
</p><p>Advanced users may want to try our custom-built script, provided <a href="http://pastebin.com/kiVCE5Fh">here</a>. Be sure to substitute your own login information.<br />
            </p><p>
            ...
            <p>
                You can find a more indepth FAQ about registration <a href="/faq/registration/">here</a>.
</p>
            <br />
            <h3>5. Set your stream</h3>
            <p>
                Type <code>.setstream twitch/<em>name</em></code> in the <strong>#speedrunslive</strong> channel to link your stream to SRL. Hitbox.tv is also supported for front page appearance but currently <a href="/news/hitbox/">not for racing</a>. This applies to races where streaming is required.</p>

            <p>
                Additional information:
<ul>
                    <li>You only need to do this once. You do not need to do it every time you log in or race.<br /></li>
                    <li>Your stream will appear on the Streams page of the site after 1 total hour of racing. You will need to visit the website while logged in once per month to stay on. Alternatively you can join the <strong>#speedrunslive</strong> channel on IRC while identified at least once a month.<br />
                    </li>
                    <li>You may substitute <code>Twitch</code> for <code>Hitbox</code>, but Hitbox.tv is currently not supported for racing.<br />
                    </li>
                    <li>In your Twitch options, turn on &quot;Automatically archive my broadcasts&quot; in the Channel & Videos section. This will allow our moderators to check your VODs after the race if necessary.<br />
                    </li>
                </ul></p>
            <h3>6. Familiarize yourself with RaceBot commands</h3>
            <p>
                A full listing of RaceBot commands can be found <a href="/faq/commandlist/">here</a>.
</p>
            <br />
            <h3>7. Review the rules to racing on SRL</h3>
            <p>
                Our rules page can be found <a href="/faq/rules">here</a>.
</p>
            <br />
            <h3>8. Review the Racing section of this FAQ</h3>
            <p>
                The racing section of the FAQ can be found <a href="#racing">here</a>.<br />
            </p><p>
                After doing all of the above, you are ready for your first race. You can join any races with an ENTRY OPEN status. Alternatively, after confirming you have an opponent you can start your own race via the <code>.startrace</code> command.
</p>
            <br />
            ...
            <ul>
                <li>Join our IRC network as described above, and type <code>/list</code>. Browse through the list of IRC channels which comes up, and see if any pertain to your game or its series. Joining the community for a particular game or series is often the best first step towards getting more involved and learning more about it.</li>
                <li>Visit the <a href="http://forum.speeddemosarchive.com">SDA forums</a> and see if there is an existing thread about your game.</li>
                <li>There may be an existing site out there devoted entirely to providing strategies, routes, and/or leaderboards for your game or its series. Do a quick Google search and see what comes up!</li>
            </ul>
            <div className="faqdivider">
            </div>
            ...
            <br />
            <h2 id="newgame">Can I race a game that's not on the SRL <a href="/races/#!/gamelist/alphabetical">game list</a>?</h2>
            <p>
                Yes, we encourage it!
</p>
            <p>
            ...
            <p>If the emulator is accurate and the community for that game accepts emulator as a valid choice, then yes, you can. The most commonly used emulators for each system include:</p>

            <ul>
                <li><b>NES</b> - FCEUX 2.2.0</li>
                <li><b>GB</b> - bgb</li>
                <li><b>SNES</b> - SNES9x 1.53</li>
                <li><b>GBA</b> - VBA 1.7.2</li>
                <li><b>Genesis/GameGear/SMS</b> - Fusion</li>
                <li><b>N64</b> - Project64 v1.7</li>
            </ul>
            ...
            <ul>
                ...
                <li><b>GB/GBC</b> - VBA, VBA-M</li>
                <li><b>GBA</b> - VBA-M (use VBA instead. If VBA does not support your GBA game, please contact an op.)</li>
            </ul>
            <br />

            <h2 id="setstream">How do I get my stream to appear on the races page of SpeedRunsLive?</h2>

            <p>Type <code>.setstream twitch/<em>name</em></code> to link your stream to SRL, if you have not done so already. Please note that Hitbox.tv is not currently supported for racing.</p>
            <br />

            <h2 id="nostream">What if I can't stream but still want to race?</h2>

            <p>It is strongly preferred that you stream for racing. If you are asked for proof, you must figure out a way to show proof of completion of the goal. Otherwise, you will be disqualified (and possibly banned). If you are playing on an emulator, or if you are racing a <a href="/races/#!/seasons/1">season goal</a>, you are required to stream (NO exceptions). However, if you are playing on a console, you are not required to stream. For more details about streaming and proofcalling, read below.</p>
            <br />
            ...
            <p>Streaming is not a requirement for all racing on SpeedRunsLive, but we prefer that you do so, not only for our sake, but for your own as well. Please see specifics of streaming below.</p>
            ...
            <p>A season is a 3 month, ranked competition of races. Season 1 ran from April 12, 2013 to September 8, 2013. Streaming is required for Seasons goals, regardless of whether you're playing on console or emulator. To learn more about seasons, <a href="/races/#!/seasons/1">click here</a>.</p>
            <br />
            ...
            <p>What you should pick up from this list is that it's the game's community drives the ruleset. Nothing is set in stone.</p>

            <div className="faqdivider">
            </div>
            <h1 id="frontpage">Front page</h1>
            <h2 id="howfrontpage">How do I get my stream to appear on the front page of SpeedRunsLive?</h2>
            <p>Type <code>.setstream twitch/<em>name</em></code> to link your stream to SRL, if you have not done so already.
Your stream will appear on the Streams page of the site after 1 hour of racing. You may not appear immediately, as our system checks at specific times throughout the day.
            ...
            <p>When logged in via the site, you can click Edit Profile to toggle whether or not you appear on the front page, depending on what you are streaming.</p>

            <p>If you are found streaming non-speedrun content to the front page, you will be flagged and automatically hidden. Depending on quantity of recent offenses, you will be temporarily blacklisted as follows:
<ul>
            ...
            <ol>
                ...
                <li>All donation links presented on stream or marathon related websites should go directly to the charity's PayPal or another proven payment method. No proceeds should go towards personal causes.</li>
            </ol>
            <p>Additional notes:</p>
            <ul>
                <li>If you'd like to use PayPal but your charity does not accept it, you should contact them ahead of time to see if they are able to set up a PayPal address for you in their domain name.</li>
                <li>Do not add or modify donation links after the stream has been whitelisted.</li>
                <li>We may not whitelist marathons for personal causes, such as medical bills or travel costs to get to another marathon (even if “excess” funds go to a charity).</li>
                <li>Users are free to host marathons for whatever cause they wish on their own SRL nick under their own Twitch name, be it for charity, personal, etc. Exploiting a loophole by using one’s racing nick and doing <code>.setstream</code> to a marathon Twitch channel is not acceptable, and may result in your stream being temporarily blacklisted from the front page.</li>
                <li>After the marathon concludes, the stream will be un-whitelisted. If another marathon happens on the channel in the future, please re-submit the request.</li>
            </ul>
            <p>If you would like your marathon to be whitelisted, please PM a moderator, and/or send an e-mail to the SRL e-mail address at <a href="mailto:staff@speedrunslive.com">staff@speedrunslive.com</a>.</p>
            <br />
            ...
            <p>These types of marathons may be allowed on a case by case basis. Regardless, you can still host the marathon on your own personal Twitch channel.</p>
            <p>Any races done on a marathon account to circumvent the stream requirement will be ended, and may result in the marathon being blacklisted.</p>
            ...
            <p>
                You may also edit your settings via the corresponding <a href="/faq/commandlist/#settwitter">RaceBot commands</a>.
</p>
            <br />
            ...
            <ul>
                ...
                <li>SRL is fully supported by donations. You could always help by donating <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=SQ2NXSJRUVWLW">here</a>! 100% of donations go towards the various costs associated with keeping the SRL site and IRC running. </li>
            </ul>
            <br />
