  ...
  return (
    <div className="row rules">
      ...
      <div className="pull-left col-md-9" id="faq">
        ...
        <p> Below are the rules for racing on the SRL IRC network. While we recommend reading the <Link to="/faq">FAQ</Link> in
          full, you <em>must</em> familiarize yourself with the following rules, or you put yourself at a high
        ...
        <ul>
          <li>Absolutely no emulator functions, such as savestates or speedups. No turbo-fire functions unless it is available on
            the original controller. No external devices such as game genie or gameshark. No scripts unless specifically allowed.
            No typing .done if you haven't finished the goal. See <a href="/faq#turboetc">FAQ</a> for more details.
          ...
          <li>You must stream if you are playing on emulator or are playing a PC game. See <a href="/faq#proofcall">FAQ</a> for more
            details.
            ...
            <p>
              ...
              “Automatically archive my broadcasts” option. This will allow anyone to watch your VOD after you stop streaming.
              <em> If you livestreamed your race but cannot provide a video upon being proofcalled, you may be DQed.</em> 
              Note that this option is off by default.
            </p>
          </li>
          ...
          <li>If you need to change a goal mid-race, be sure that every single entrant still racing agrees to it.
            <p><strong>Result:</strong> If even one person doesn’t respond or disagrees, the goal must stay as is.</p>
          </li>
          <li>No extended breaks, such as sleeping, during a race. A safe go by is no more than 10 minutes at a time, per hour.
            <p><strong>Result:</strong> DQ'd from race.</p>
          </li>
        ...
        <ul>
          <li>No connecting via a tor service.
            <p><strong>Result:</strong> Ban as long as you use that service.</p>
          </li>
          <li>No racing on more than 1 nick.
            <p><strong>Result:</strong> May be banned if repeated.</p>
          </li>
          <li>If you consistently stream material that is clearly unacceptable to the front page, you will be warned.
            <p><strong>Result:</strong> If it continues (or is severe enough to not deserve a warning), you may be blacklisted from
              the front page.</p>
          </li>
          <li>Do not use derogatory terms. Do not harass other members.
            <p><strong>Result:</strong> Warning, temporary ban, or permanent ban depending on the circumstances.</p>
          </li>
