  ...
  return (
    <div className="row commandList">
      ...
      <div className="pull-left col-md-9" id="faq">
        ...
        <h2 id="startrace">.startrace <em>game</em> <span className="pull-right dull">main channel</span></h2>
        ...
        <h2 id="enter">.enter <span className="pull-right dull">race channel</span></h2>
        <p>Type this to enter the race.</p>

        <h2 id="unenter">.unenter <span className="pull-right dull">race channel</span></h2>
        <p>Removes you from the race.</p>
        <p>If a race is in progress, you cannot unenter. You must <code>.quit</code> instead.</p>

        <h2 id="entrants">.entrants <span className="pull-right dull">race channel</span></h2>
        <p>Shows the full list of entrants and their status in the race.</p>

        <h2 id="ready">.ready <span className="pull-right dull">race channel</span></h2>
        <p>Use this to ready up.</p>
        <p>Once everybody in the race is ready, the race will begin.</p>

        <h2 id="unready">.unready <span className="pull-right dull">race channel</span></h2>
        <p>Use this if you are no longer ready.</p>

        <h2 id="time">.time <span className="pull-right dull">race channel</span></h2>
        <p>Checks the elapsed time of the race.</p>

        <h2 id="goal">.goal <span className="pull-right dull">race channel</span></h2>
        <p>Checks the goal of the race.</p>

        <h2 id="setgoal">.setgoal <em>goal</em> <span className="pull-right dull">race channel</span></h2>
        <p>Sets the goal of the race.</p>
        <p>A goal must be set before players may ready up.</p>

        <h2 id="setgame">.setgame <em>game</em> <span className="pull-right dull">race channel</span></h2>
        ...
        <h2 id="done">.done <span className="pull-right dull">race channel</span></h2>
        ...
        <h2 id="undone">.undone <span className="pull-right dull">race channel</span></h2>
        <p>Use this command if you accidentally did <code>.done</code> early, or if you <code>.quit</code> and want to continue
          playing.
        </p>

        <h2 id="quit">.quit <span className="pull-right dull">race channel</span></h2>
        ...
        <h2 id="comment">.comment <em>comment</em> <span className="pull-right dull">race channel</span></h2>
        <p>You may leave a comment on a race that you finished participating in. Limit is 140 characters.</p>

        <h2 id="rematch">.rematch <span className="pull-right dull">race channel</span></h2>
        ...
        <h2 id="races">.races <span className="pull-right dull">main channel</span></h2>
        <p>Checks which races are going on.</p>

        <h2 id="setstream">.setstream <em>url</em> <span className="pull-right dull">all channels</span></h2>
        <p>Use this to set your stream on SRL.</p>
        <p>Example: <code>.setstream http://twitch.tv/blechzorz</code></p>

        <h2 id="streamoption">.streamoption <em>option</em> <span className="pull-right dull">all channels</span></h2>
        ...
        <h2 id="stream">.stream <em>name</em> <span className="pull-right dull">all channels</span></h2>
        <p>Gives the stream url of the requested name.</p>

        <h2 id="settwitter">.settwitter <em>twitter</em> <span className="pull-right dull">all channels</span></h2>
        <p>Use this to set your Twitter account.</p>

        <h2 id="twit">.twitter <em>name</em> <span className="pull-right dull">all channels</span></h2>
        <p>Gives the Twitter account of the requested name.</p>

        <h2 id="setyoutube">.setyoutube <em>account</em> <span className="pull-right dull">all channels</span></h2>
        <p>Use this to set your YouTube account.</p>

        <h2 id="youtube">.youtube <em>name</em> <span className="pull-right dull">all channels</span></h2>
        <p>Gives the YouTube account of the requested name.</p>

        <h2 id="filename">.filename <span className="pull-right dull">race channel</span></h2>
        ...
        <h2 id="queue">.queue <span className="pull-right dull">main channel</span></h2>
        <p>Gives the list of completed races that have yet to be ended/recorded.</p>

        <h2 id="record">.record <span className="pull-right dull">race channel</span></h2>
        <p>Use this to record completed races.</p>
        <p>Before you record a race, make sure everything is in order.</p>

        <h2 id="end">.end <span className="pull-right dull">race channel</span></h2>
        ...
        <h2 id="dq">.dq <em>name</em> <em>reason</em> <span className="pull-right dull">race channel</span></h2>
        ...
        <h2 id="remove">.remove <em>name</em> <span className="pull-right dull">race channel</span></h2>
        ...
        <h2 id="creategame">.creategame <em>game</em> <em>Full Game Name</em> <span className="pull-right dull">all channels</span></h2>
        ...
        <h2 id="purge">.purge <em>name</em> <span className="pull-right dull">all channels</span></h2>
